...
#define _CRYPTO_is_ARMv8_AES_capable_at_runtime BORINGSSL_ADD_PREFIX_MAC_ASM(BORINGSSL_PREFIX, CRYPTO_is_ARMv8_AES_capable_at_runtime)
#define _CRYPTO_is_ARMv8_PMULL_capable_at_runtime BORINGSSL_ADD_PREFIX_MAC_ASM(BORINGSSL_PREFIX, CRYPTO_is_ARMv8_PMULL_capable_at_runtime)
